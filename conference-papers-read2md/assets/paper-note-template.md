---
# Source: adapted from huangkiki/dailypaper-skills paper-reader/assets/paper-note-template.md
# Changes: used by conference-papers-read2md for data/_inbox Obsidian notes.
title: "{Title}"
...
<!-- 图片默认使用 arXiv HTML / 项目主页等网络链接；仅外链不可用或用户要求离线归档时再本地化。 -->
<!-- 外链示例: ![Figure 1]({figure1_url}) -->
