<!-- Source: adapted from huangkiki/dailypaper-skills paper-reader/references/cv-dl-terminology.md. -->
<!-- Changes: optional terminology reference for conference-papers-read2md paper reading. -->
