<!-- Source: adapted from huangkiki/dailypaper-skills paper-reader/references/image-troubleshooting.md. -->
<!-- Changes: reused for conference-papers-read2md inbox image localization. -->
