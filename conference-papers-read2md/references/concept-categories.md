<!-- Source: adapted from huangkiki/dailypaper-skills paper-reader/references/concept-categories.md. -->
<!-- Changes: reused for concept-link naming guidance in conference-papers-read2md notes. -->
